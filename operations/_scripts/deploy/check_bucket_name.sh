...
# TODO: This file is copied verbatim from https://github.com/bitovi/github-actions-docker-to-azure-vm/blob/main/operations/_scripts/deploy/check_bucket_name.sh
