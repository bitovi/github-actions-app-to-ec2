...
# TODO: This file is copied almost verbatim from https://github.com/bitovi/github-actions-docker-to-azure-vm/blob/main/operations/_scripts/deploy/deploy.sh
